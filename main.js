...
random_num = Math.floor((Math.random()*quick_draw_data_set.length)+1);
...
function gotResult(error, results){
    ...
    document.getElementById("guessed_sketched").innerHTML = 'Your Sketch: ' + drawn_sketch;
